...
main :: IO Counts
main = runTestTT $ TestList [testIsEmptyDEQ, testLengthDEQ, testFirstDEQ, testLastDEQ, testTakeFrontDEQ, testTakeBackDEQ, testPushFrontDEQ, testPopFrontDEQ, testPushBackDEQ, testPopBackDEQ]
